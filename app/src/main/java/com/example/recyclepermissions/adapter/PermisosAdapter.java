package com.example.recyclepermissions.adapter;
        ...
        import com.example.recyclepermissions.Listener;
        import com.example.recyclepermissions.R;
...
public class PermisosAdapter extends RecyclerView.Adapter<PermisosAdapter.ViewHolder> {
    ...
    public PermisosAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v=ly.inflate(R.layout.activity_permisos, parent,false);
